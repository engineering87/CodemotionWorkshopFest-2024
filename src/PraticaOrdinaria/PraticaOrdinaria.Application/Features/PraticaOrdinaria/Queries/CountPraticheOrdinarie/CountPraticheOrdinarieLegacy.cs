...
{
    public class CountPraticheOrdinarieLegacy : IRequest<Response<int>>
    {
    }

    public class CountPraticheOrdinarieLegacyHandler(IPraticaOrdinariaRepositoryAsync praticheOrdinarieRepository)
        : IRequestHandler<CountPraticheOrdinarieLegacy, Response<int>>
    {
        private readonly IPraticaOrdinariaRepositoryAsync _praticheOrdinarieRepository = praticheOrdinarieRepository;

        public async Task<Response<int>> Handle(CountPraticheOrdinarieLegacy query, CancellationToken cancellationToken)
        {
